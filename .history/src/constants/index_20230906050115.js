...
const projects = [
	{
		...
		name: "AT&T",
		description:
			"AT&T is leading the charge with our nationwide fast, reliable and secure 5G coupled with our growing, multi-gig fiber internet service.",
		tags: [
			{
				name: "Next.js",
	...
	},
	{
		...
		name: "RGC",
		description:
			"Robert Geans Corporation has been family owned and operated since 1959. You don’t last this long without doing something right, and we’ve mastered what sets us apart. ",
		tags: [
			{
				name: "Next.js",
				color: "blue-text-gradient",
